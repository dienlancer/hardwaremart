...
<head>
	...
	<script src="<?php echo e(asset('public/frontend/js/jquery-3.2.1.js')); ?>"></script>
	<!--begin bootstrap-->
	...
	<!--end bootstrap-->
	<!-- begin jquery-ui -->
	<script src="<?php echo e(asset('public/frontend/jquery-ui/jquery-ui.min.js')); ?>"></script>
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/jquery-ui/jquery-ui.css')); ?>" />
	<!-- end jquery-ui -->
	<!-- begin font-awesome -->
	...
	<!-- end font-awesome -->	
	<!-- begin ddsmoothmenu -->
	<script src="<?php echo e(asset('public/frontend/js/ddsmoothmenu.js')); ?>"></script>
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/ddsmoothmenu.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/ddsmoothmenu-v2.css')); ?>" />
	<!-- end ddsmoothmenu -->
	<!-- begin slick slider -->
	<script src="<?php echo e(asset('public/frontend/slick/slick.min.js')); ?>"></script>
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/slick/slick.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/slick/slick-theme.css')); ?>" />
	<!-- end slick slider -->
	<!-- begin tab -->
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/tab.css')); ?>" />
	<!-- end tab-->
	<!-- begin bxslider -->
	<script src="<?php echo e(asset('public/frontend/bxslider/jquery.bxslider.min.js')); ?>"></script>
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/bxslider/jquery.bxslider.min.css')); ?>" />  
	<!-- end bxslider -->
	<!-- begin owl_carousel -->
	<script src="<?php echo e(asset('public/frontend/owl-carousel-2/owl.carousel.min.js')); ?>"></script>
	<script src="<?php echo e(asset('public/frontend/owl-carousel-2/owl.carousel2.thumbs.min.js')); ?>"></script>
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/owl-carousel-2/owl.carousel.min.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/owl-carousel-2/owl.theme.min.css')); ?>" /> 
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/owl-carousel-2/themes.css')); ?>" />  
	<!-- end owl_carousel -->
	<!-- begin elevatezoom -->
	<script src="<?php echo e(asset('public/frontend/js/jquery.elevatezoom-3.0.8.min.js')); ?>"></script>  
	<!-- end elevatezoom -->
	<!-- begin accounting -->
	<script src="<?php echo e(asset('public/frontend/js/accounting.min.js')); ?>"></script>  
	<!-- end accounting -->
	<!-- begin pagination -->
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/pagination.css')); ?>" />
	<!-- end pagination-->
	<!-- begin product -->
	...
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/jquery.dataTables.min.css')); ?>" />
	<script src="<?php echo e(asset('public/frontend/js/table-library.js')); ?>"></script>    
	<!-- end datatables -->
	<!-- begin youtube -->    
  <script src="<?php echo e(asset('public/frontend/js/jquery-modal-video.min.js')); ?>"></script>
  <script src="<?php echo e(asset('public/frontend/js/modal-video.min.js')); ?>"></script>
  <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/modal-video.min.css')); ?>" />
  <!-- end youtube -->
	<!-- begin fancybox -->
	<script language="javascript" type="text/javascript" src="<?php echo e(asset('public/frontend/js/jquery.fancybox.min.js')); ?>"                 ></script>
	<link href="<?php echo e(asset('public/frontend/css/jquery.fancybox.min.css')); ?>" rel="stylesheet" type="text/css" />
	<!-- end fancybox -->
	<!-- begin ckeditor-->
	<script language="javascript" type="text/javascript" src="<?php echo e(asset('public/frontend/ckeditor/ckeditor.js')); ?>"                 ></script>
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/frontend/ckfinder/ckfinder.js')); ?>"                 ></script>
    <!-- end ckeditor-->
	<!-- begin custom -->
	<script language="javascript" type="text/javascript" src="<?php echo e(asset('public/frontend/js/spinner.js')); ?>"                 ></script>
	<script src="<?php echo e(asset('public/frontend/js/custom.js')); ?>"></script>    
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/template.css')); ?>" />
	<!-- end custom -->
